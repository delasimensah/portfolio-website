...
const VALUE_PROPS = [
  {
    icon: <IconClipboardList size={20} className={ICON_WHITE} />,
    title: "Structured scoping",
  },
  {
    icon: <IconChartLine size={20} className={ICON_WHITE} />,
    title: "Decisions tied to your business goals",
  },
  {
      ...
      <Box className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <FadeInSection className="mx-auto max-w-4xl">
          ...
          <Box className="rounded-xl border border-gray-800 bg-bg-surface p-8 lg:p-12">
            <Title
              order={3}
              className="mb-8 text-center text-2xl font-bold text-text-primary"
            >
            ...
            <Box className="space-y-3 border-t border-gray-800 pt-8 text-center">
              ...
              <Text className="text-xl font-semibold text-accent-primary">
                If you need a product you can run a business on, that&apos;s
                where I come in.
              </Text>
            </Box>
          </Box>
